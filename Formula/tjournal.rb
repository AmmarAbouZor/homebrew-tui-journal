class Tjournal < Formula
    ...
    on_macos do
      on_arm do
        url "https://github.com/AmmarAbouZor/tui-journal/archive/v0.12.1/tjournal-mac-arm64.tar.gz"
        sha256 "bd518d851103d12db23dfbc5a9d4338a097f2bcf7de8e0c79cb8b948b456f8b0"
      end
      on_intel do
        url "https://github.com/AmmarAbouZor/tui-journal/archive/v0.12.1/tjournal-mac-x86_64.tar.gz"
